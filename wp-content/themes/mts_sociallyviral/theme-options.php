...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => sprintf( __('Upload a %s image that will represent your website\'s favicon.', 'sociallyviral' ), '<strong>32 x 32 px</strong>' )
						),
					array(
						'id' => 'mts_touch_icon',
						'type' => 'upload',
						'title' => __('Touch icon', 'sociallyviral' ),
						'sub_desc' => sprintf( __('Upload a %s image that will represent your website\'s touch icon for iOS 2.0+ and Android 2.1+ devices.', 'sociallyviral' ), '<strong>152 x 152 px</strong>' )
						),
					array(
						'id' => 'mts_metro_icon',
						'type' => 'upload',
						'title' => __('Metro icon', 'sociallyviral' ),
						'sub_desc' => sprintf( __('Upload a %s image that will represent your website\'s IE 10 Metro tile icon.', 'sociallyviral' ), '<strong>144 x 144 px</strong>' )
						),
					array(
					...
					array(
						...
						'sub_desc' => sprintf( __('Enter your FeedBurner\'s URL here, ex: %s and your main feed (http://example.com/feed) will get redirected to the FeedBurner ID entered here.)', 'sociallyviral' ), '<strong>http://feeds.feedburner.com/mythemeshop</strong>' ),
						'validate' => 'url'
						),
					array(
						'id' => 'mts_header_code',
						...
						'sub_desc' => wp_kses( __('Enter the code which you need to place <strong>before closing &lt;/head&gt; tag</strong>. (ex: Google Webmaster Tools verification, Bing Webmaster Center, BuySellAds Script, Alexa verification etc.)', 'sociallyviral' ), array( 'strong' => array() ) )
						),
					array(
						'id' => 'mts_analytics_code',
						'type' => 'textarea',
						'title' => __('Footer Code', 'sociallyviral' ),
						'sub_desc' => wp_kses( __('Enter the codes which you need to place in your footer. <strong>(ex: Google Analytics, Clicky, STATCOUNTER, Woopra, Histats, etc.)</strong>.', 'sociallyviral' ), array( 'strong' => array() ) )
						),
					array(
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'sub_desc' => sprintf( __('Add %s attribute to script tags to improve page download speed.', 'sociallyviral' ), '<code>async</code>' ),
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'std' => '1',
					),
					array(
						...
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'sub_desc' => sprintf( __('Remove %s parameter from CSS and JS file calls. It may improve speed in some browsers which do not cache files having the parameter.', 'sociallyviral' ), '<code>ver</code>' ),
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'std' => '1',
					),
					array(
					...
					'cache_message' => array(
						...
						'desc' => sprintf(
							__('A cache plugin can increase page download speed dramatically. We recommend using %1$s or %2$s.', 'sociallyviral' ),
...
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'sub_desc' => wp_kses( __('Use this button to Show or Hide the <strong>Logo</strong> completely.', 'sociallyviral' ), array( 'strong' => array() ) ),
						'std' => '1'
					),
					array(
					...
					array(
						...
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'sub_desc' => sprintf( __('Use this button to enable %s.', 'sociallyviral' ), '<strong>' . __('Floating Navigation Menu', 'sociallyviral' ) . '</strong>' ),
						'std' => '0'
						),
                    array(
						...
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'sub_desc' => sprintf( __('Use this button to enable %s.', 'sociallyviral' ), '<strong>' . __( 'Primary Navigation Menu', 'sociallyviral' ) . '</strong>' ),
						'std' => '1'
						),
					array(
...
$sections[] = array(
				...
				'fields' => array(
                    ...
                    array(
						...
						'sub_desc' => wp_kses( __('Choose the number of widget areas in the <strong>footer</strong>.', 'sociallyviral' ), array( 'strong' => array() ) ),
						'options' => array(
					...
					array(
						...
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'sub_desc' => wp_kses( __('Use this button to Show or Hide <strong>Footer Navigation</strong> completely.', 'sociallyviral' ), array( 'strong' => array() ) ),
						'std' => '1'
					),
					array(
						'id' => 'mts_copyrights',
						...
						'sub_desc' => __( 'You can change or remove our link from footer and use your own custom text.', 'sociallyviral' ) . ( MTS_THEME_WHITE_LABEL ? '' : wp_kses( __('(You can also use your affiliate link to <strong>earn 55% of sales</strong>. Ex: <a href="https://mythemeshop.com/go/aff/aff" target="_blank">https://mythemeshop.com/?ref=username</a>)', 'sociallyviral' ), array( 'strong' => array(), 'a' => array( 'href' => array(), 'target' => array() ) ) ) ),
						'std' => MTS_THEME_WHITE_LABEL ? null : sprintf( __( 'Theme by %s', 'sociallyviral' ), '<a href="http://mythemeshop.com/" rel="nofollow">MyThemeShop</a>' )
					),
				)
			);
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'sub_desc' => wp_kses( __('Choose the <strong>layout design</strong> for your homepage.', 'sociallyviral' ), array( 'strong' => array() ) ),
						'options' => array(
					...
					array(
						...
						'sub_desc' => wp_kses( __('<strong>Enable or Disable</strong> larger first post.', 'sociallyviral' ), array( 'strong' => array() ) ),
						'std' => '1',
					...
					array(
						...
						'options' => array( '0' => __( 'Off', 'sociallyviral' ), '1' => __( 'On', 'sociallyviral' ) ),
						'sub_desc' => wp_kses( __('<strong>Enable or Disable</strong> homepage slider with this button. The slider will show recent articles from the selected categories.', 'sociallyviral' ), array( 'strong' => array() ) ),
						'std' => '0',
                        'args' => array('hide' => 3)
					),
					array(
						...
						'sub_desc' => wp_kses( __('Select a category from the drop-down menu, latest articles from this category will be shown <strong>in the slider</strong>.', 'sociallyviral' ), array( 'strong' => array() ) ),
					),
                    array(
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => wp_kses( __('Use this button to Show or Hide Post Meta Info <strong>Author name and Categories</strong>.', 'sociallyviral' ), array( 'strong' => array() ) ),
						'std' => '1'
					),
					array(
