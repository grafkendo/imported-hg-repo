...
function mts_get_icons() {
    $icons = array(
        ...
        __( 'Accessibility Icons', 'sociallyviral' ) => array(
...
function mts_enqueue_css() {
    ...
    $custom_css = "
        ...
        #searchform .fa-search, .currenttext, .pagination a:hover, .single .pagination a:hover .currenttext, .page-numbers.current, .pagination .nav-previous a:hover, .pagination .nav-next a:hover, .single-prev-next a, .tagcloud a, #commentform input#submit, .contact-form #mtscontact_submit, .woocommerce-product-search input[type='submit'], .woocommerce-account .woocommerce-MyAccount-navigation li.is-active { background-color: {$mts_options['mts_color_scheme_2']}; }
...
if ( mts_is_wc_active() ) {
    ...
    function mts_header_add_to_cart_fragment( $fragments ) {
        ...
        <a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php _e( 'View your shopping cart', 'sociallyviral' ); ?>"><?php echo sprintf( _n( '%d item', '%d items', $woocommerce->cart->cart_contents_count, 'sociallyviral' ), $woocommerce->cart->cart_contents_count );?> - <?php echo $woocommerce->cart->get_cart_total(); ?></a>
