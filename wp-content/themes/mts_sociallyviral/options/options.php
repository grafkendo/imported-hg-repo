	...
	function _options_page_html(){
		...
		echo '<div class="wrap"><h2></h2>';
			...
			echo '<form method="post" action="options.php" enctype="multipart/form-data" id="nhp-opts-form-wrapper">';
				...
				if ( ! MTS_THEME_WHITE_LABEL ) {
					echo '<a href="https://community.mythemeshop.com/forum/7-theme-support/" class="docsupport" target="_blank"><i class="fa fa-medkit"></i> '.__('Support', 'sociallyviral').'</a>';
				}
					echo '<div class="theme-options-search"><a href="#" class="theme-options-clear-search"><i class="dashicons dashicons-no"></i></a> <input type="text" id="search-theme-options" value="" placeholder="'.esc_attr__('Search Options', 'sociallyviral').'"><a href="#" class="options-search-link"><i class="fa fa-search"></i><span> '.__('Search Options', 'sociallyviral').'</span></a></div>';
				...
				echo '<div id="nhp-opts-main">';
					...
					echo '<div id="options-search-no-results">'.__('No options found, please refine your query.', 'sociallyviral' ).'</div><!--search: no results-->';
