	...
	function render(){
		...
		$css_options = array(
			'repeat'	 => array(
				...
				'no-repeat' => __('No Repeat', 'sociallyviral' ),
				'repeat'	=> __('Repeat All', 'sociallyviral' ),
				'repeat-x'  => __('Repeat Horizontally', 'sociallyviral' ),
				'repeat-y'  => __('Repeat Vertically', 'sociallyviral' ),
				//'inherit'   => 'Inherit',
			),
			'attachment' => array(
				''		=> __('Default', 'sociallyviral' ),
				'fixed'   => __('Fixed', 'sociallyviral' ),
				'scroll'  => __('Scroll', 'sociallyviral' ),
				//'inherit' => 'Inherit',
			),
			'position'   => array(
				''			  => __('Default', 'sociallyviral' ),
				'left top'	  => __('Left Top', 'sociallyviral' ),
				'left center'   => __('Left center', 'sociallyviral' ),
				'left bottom'   => __('Left Bottom', 'sociallyviral' ),
				'center top'	=> __('Center Top', 'sociallyviral' ),
				'center center' => __('Center Center', 'sociallyviral' ),
				'center bottom' => __('Center Bottom', 'sociallyviral' ),
				'right top'	 => __('Right Top', 'sociallyviral' ),
				'right center'  => __('Right center', 'sociallyviral' ),
				'right bottom'  => __('Right Bottom', 'sociallyviral' ),
			),
			'size'	   => array(
				''		=> __('Default', 'sociallyviral' ),
				//'inherit' => 'Inherit',
				'cover'   => __('Cover', 'sociallyviral' ),
				'contain' => __('Contain', 'sociallyviral' ),
			),
			'parallax'   => array(
