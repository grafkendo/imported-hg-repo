								...
								<div class="single_post">
									...
									<div class="post-single-content box mark-links entry-content">
										...
										<div class="single-prev-next">
											<?php previous_post_link('%link', '<i class="fa fa-long-arrow-left"></i> '.__('Prev Article','sociallyviral')); ?>
											<?php next_post_link('%link', __('Next Article','sociallyviral').' <i class="fa fa-long-arrow-right"></i>'); ?>
										</div>
