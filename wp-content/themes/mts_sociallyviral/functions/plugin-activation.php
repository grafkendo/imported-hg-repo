        ...
        protected function get_plugin_source_type_text( $type ) {
            ...
            switch ( $type ) {
                case 'repo':
                    ...
                    break;
                case 'external':
                    $string = __( 'Mythemeshop', 'sociallyviral' );
                    break;
                case 'bundled':
                    ...
                    public function add_strings() {
                        if ( 'update' === $this->options['install_type'] ) {
                            ...
                            if ( $this->tgmpa->is_automatic ) {
                                ...
                                $this->upgrader->strings['skin_update_successful']  = __( '%1$s installed and activated successfully.', 'sociallyviral' );
                                ...
                                $this->upgrader->strings['skin_update_successful']  = esc_html__( '%1$s installed successfully.', 'sociallyviral' );
...
function mts_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'description' => __( 'A simple and easy way to update your MyThemeShop themes and plugins to the the latest versions using good old one click method!', 'sociallyviral' ),
            'required'  => false,
        ...
        array(
            ...
            'alt_description' => __( 'WP Tab Widget Pro is the most powerful plugin for showing recommended content on blog posts to increase engagement and keep visitors on your site purpose.', 'sociallyviral' ),
        ...
        array(
            ...
            'alt_description' => __( 'WP Quiz is a completely FREE quiz plugin that will let you create endlessly customizable and highly professional quizzes for your WordPress site.', 'sociallyviral' ),
                    ...
                    foreach ( $plugins as $plugin ) :
                        ...
                        if ( $tgma_instance->is_plugin_installed( $plugin['slug'] ) ) {
                            ...
                            if ( false !== $tgma_instance->does_plugin_have_update( $plugin['slug'] ) && $tgma_instance->can_plugin_update( $plugin['slug'] ) ) {
                                $update_button = '<a class="update-now-alt button" href="" data-slug="'.esc_attr( $plugin['slug'] ).'" data-plugin="'.esc_attr( $plugin['file_path'] ).'" aria-label="" data-name="' . esc_attr( $plugin['name'] ) . '">'.__('Update Now', 'sociallyviral' ).'</a>';
                            }
