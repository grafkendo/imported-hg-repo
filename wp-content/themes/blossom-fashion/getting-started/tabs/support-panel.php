...
if( $theme_active == 'blossom-fashion' ){
    ...
    $theme_link    = $theme_active . '-free-wordpress-theme';
}
...
<div id="support-panel" class="panel-left">
	<div class="toggle-block active">
		<h3 class="toggle-title"><?php _e( 'What is the difference between Free and Pro?', 'blossom-fashion' ); ?></h3>
	...
	<div class="toggle-block">
		<h3 class="toggle-title"><?php _e( 'What are the advantages of upgrading to the Premium version?', 'blossom-fashion' ); ?></h3>
		<div class="toggle-content">
	...
	<div class="toggle-block">
		<h3 class="toggle-title"><?php _e( 'Upgrading to the Pro version- will I lose my changes?', 'blossom-fashion' ); ?></h3>
		<div class="toggle-content">
	...
	<div class="toggle-block">
		<h3 class="toggle-title"><?php _e( 'How do I change the copyright text?', 'blossom-fashion' ); ?></h3>
		<div class="toggle-content">
	...
	<div class="toggle-block">
		<h3 class="toggle-title"><?php _e( 'Why is my theme not working well?', 'blossom-fashion' ); ?></h3>
		<div class="toggle-content">
	...
	<div class="toggle-block">
		<h3 class="toggle-title"><?php _e( 'How can I solve my issues quickly and get faster support?', 'blossom-fashion' ); ?></h3>
		<div class="toggle-content">
